...
Debug_Include_Path= -I"/usr/local/include/opencv" -I"/usr/src/linux-headers-3.2.0-33/arch/um/include/shared" -I"/usr/local/include/opencv2/legacy/"
#Release_Include_Path=-I"../../../../../../OpenCV2.0/include/opencv" 
Release_Include_Path= -I"/usr/local/include/opencv" -I"/usr/src/linux-headers-3.2.0-33/arch/um/include/shared" -I"/usr/local/include/opencv2/legacy/"
...
Debug_Libraries=-Wl,--start-group   -Wl,--end-group -lopencv_calib3d -lopencv_contrib -lopencv_core -lopencv_features2d -lopencv_flann -lopencv_gpu -lopencv_highgui -lopencv_imgproc -lopencv_legacy -lopencv_ml -lopencv_nonfree -lopencv_objdetect -lopencv_photo -lopencv_stitching -lopencv_ts -lopencv_video -lopencv_videostab
#Release_Libraries=-Wl,--start-group -lcv -lcxcore -lcvaux -lhighgui  -Wl,--end-group
Release_Librarie = =-Wl,--start-group   -Wl,--end-group -lopencv_calib3d -lopencv_contrib -lopencv_core -lopencv_features2d -lopencv_flann -lopencv_gpu -lopencv_highgui -lopencv_imgproc -lopencv_legacy -lopencv_ml -lopencv_nonfree -lopencv_objdetect -lopencv_photo -lopencv_stitching -lopencv_ts -lopencv_video -lopencv_videostab -lstdc++
